function [x, i] = asplit(b, matvec, msolve, x0, tol, imax)
%
% [x, i] = asplit(b, matvec, msolve [,x0 [, tol [, imax]]]) risolve il sistema
%                                                           lineare con il metodo
%                                                           iterativo definito dalla
%                                                           function msolve con una
%                                                           matrice ricavabile dalla
%                                                           function matvec
%
n = length(b);
if nargin <= 5
